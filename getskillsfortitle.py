...
from jobsfromjson import unique_jobTitles
from datafromjson import unique_skills
...
tp = []
matched = []
input_skills = unique_jobTitles[10:20]  # "data scientist", "senior software developer", "devops admin"
...
with open('requiredSkills5.csv', 'a', newline='') as file:
